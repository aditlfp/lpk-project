    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-br from-slate-900 via-red-900 to-slate-800 text-white py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-red-100 max-w-4xl mx-auto leading-relaxed mb-6 text-lg md:text-xl text-justify backdrop-blur-sm bg-white/5 rounded-2xl p-6 border border-white/10">
          ...
          <p className="text-cyan-200 text-sm md:text-lg bg-gradient-to-r from-red-500/20 to-blue-500/20 rounded-full px-6 py-2 inline-block backdrop-blur-sm border border-white/10">
            ...
            isLastOdd ? "md:col-span-2 md:mx-[20%] lg:col-span-1 lg:mx-0" : ""
              ...
              >
                ...
                <div className="card-body text-center p-8 relative z-10 flex justify-center items-center">
                  ...
                  {/* Title with gradient */}
                  <h3 className="card-title text-xl md:text-2xl font-bold bg-gradient-to-r from-gray-800 to-red-600 bg-clip-text text-transparent justify-center mb-2 group-hover:from-red-600 group-hover:to-blue-600 transition-all duration-300">
                    {industry.title}
                  </h3>
