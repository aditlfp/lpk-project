...
const EmployeRequired = () => {
  ...
  return (
    <div className="hero min-h-[500px] bg-gradient-to-br from-slate-700 via-slate-800 to-blue-900 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          <motion.div 
            ...
            whileHover={{ scale: 1.05, boxShadow: "0 25px 50px -12px rgba(245, 158, 11, 0.4)" }}
            ...
            >
              ...
              <div className="bg-gradient-to-r from-slate-700 to-blue-800 p-6 text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-slate-200 text-sm">
                    {isSignIn ? 'Masuk untuk melanjutkan pendaftaran perusahaan' : 'Buat akun untuk mendaftarkan perusahaan Anda'}
                  </p>
                </div>
              ...
              <div className="p-6">
                ...
                <div className="relative flex items-center justify-center mb-6">
                  ...
                  <span className="bg-white px-4 text-sm text-gray-500 font-medium">atau</span>
                  <div className="border-t border-gray-200 w-full"></div>
                </div>
