    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mt-12">
          <button className="btn btn-md btn-warning text-white font-bold transition-transform duration-300 hover:scale-110 hover:bg-blue-600 hover:border-0 shadow-none">
            Lihat Semua Video
          </button>
        </div>
      </div>
